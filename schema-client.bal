...
isolated client class SchemaClient {
    private final mysql:Client dbClient;        //remove mysql
    ...
    public function init(string host, string user, string password, string database, int port, 
            mysql:Options? options = (), sql:ConnectionPool? connectionPool = ()) returns sql:Error? {                  //remove mysql
